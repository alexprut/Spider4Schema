...
abstract class TypeDrug extends TypeMedicalTherapy
{
	 ...
	 * @var	array
	 */
	protected static $clinicalPharmacology = array('value' => 'clinicalPharmacology',
		'expectedTypes' => array('Text')
	);
	...
	/**
	 * Return the 'clinicalPharmacology' Property value
	 *
	 * @return	string
	 */
	public static function pClinicalPharmacology()
	{
		return self::getValue(self::$clinicalPharmacology);
	}
