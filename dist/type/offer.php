...
abstract class TypeOffer extends TypeIntangible
{
	 ...
	 * Expected Type: Text, PhysicalActivityCategory, Thing
	 * 
	 * @var	array
	 */
	protected static $category = array('value' => 'category',
		'expectedTypes' => array('Text', 'PhysicalActivityCategory', 'Thing')
	);
	 ...
	 * @var	array
	 */
	protected static $ineligibleRegion = array('value' => 'ineligibleRegion',
		'expectedTypes' => array('Place')
	);
	...
	/**
	 * Return the 'ineligibleRegion' Property value
	 *
	 * @return	string
	 */
	public static function pIneligibleRegion()
	{
		return self::getValue(self::$ineligibleRegion);
	}
